...
## Secondary data
```{r}
# police_station_data <- read_csv("Police_Stations.csv", show_col_types = FALSE)
```
...
police_station_data <- read.csv("Police_Stations.csv")

# Create SQLite database connection
dcon <- dbConnect(SQLite(), dbname = "police_stations.db")

# Write the data to the SQLite database
dbWriteTable(dcon, "police_stations", police_station_data, overwrite = TRUE)
