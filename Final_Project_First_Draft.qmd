...
## Move to SQLite dataset
```{r}
library(RSQLite)

data_dir <- "~/Desktop/Stat405/third/"
...
dbWriteTable(dcon, "police_station_data", police_station_data, overwrite = TRUE)
...
According to the scatterplot, we find two those areas with latitude 41.85-41.90, longitude from  -87.78 to -87.60; latitude 41.75-41.80,longitude from -87.70 to -87.61
```{r}
library(dplyr)
