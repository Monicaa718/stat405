...
## Graph 1
Below is a Density Graph using geom_line()
It shows that the rate of crime seems to correlate with the season or
some other factor that varies each year.
It also shows a slow decrease in the density of crime from
2001 to 2024.
```{r}
