...
# print (lincoln_weather$'Mean Temperature [F]')
# print (lincoln_weather$'Month')
...
# Assuming 'crimes_per_type' is your data frame and 
# 'Month', 'n', 'Primary Type' are column names in your data frame.

# Convert 'Month' to a factor with levels ordered correctly
crimes_per_type$Month <- factor(crimes_per_type$Month, levels = formatC(1:12, width = 2, flag = "0"))

# Convert 'Primary Type' to a factor if it's not already
crimes_per_type$`Primary Type` <- as.factor(crimes_per_type$`Primary Type`)

# Make sure 'n' is numeric
crimes_per_type$n <- as.numeric(crimes_per_type$n)

# Plot the stacked area chart
ggplot(crimes_per_type, aes(x = `Month`, y = `n`, fill = `Primary Type`)) + 
  geom_area(stat = "identity") +
  theme_minimal() +
  labs(x = "Month", y = "Number of Crimes", fill = "Crime Type",
       title = "Monthly Crime Counts by Type")
